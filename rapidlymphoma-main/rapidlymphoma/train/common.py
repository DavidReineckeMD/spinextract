"""Common modules for rapidlymphoma training and evaluation.
...
from rapidlymphoma.models import Classifier, MLP, resnet_backbone, vit_backbone
from rapidlymphoma.datasets.srh_dataset import (SRHClassificationDataset,
                                          SRHContrastiveDataset)
from rapidlymphoma.datasets.improc import get_srh_aug_list
