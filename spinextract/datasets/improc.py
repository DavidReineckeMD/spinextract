"""Image processing functions designed to work with spinextract datasets.
...
def get_strong_aug(augs, rand_prob) -> List:
    """Strong augmentations for spinextract training"""
...
def get_srh_aug_list(augs, rand_prob=0.5) -> List:
    """Combine base and strong augmentations for spinextract training"""
